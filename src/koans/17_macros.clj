...
(defmacro infix-better [form]
  `(~(second form) ; Note the syntax-quote (`) and unquote (~) characters!
    (infix-better ~(first form))
    (infix-better ~(nth form 2))))
...
(meditations
  ...
  (= '(* (koans.17-macros/infix-better 10) (koans.17-macros/infix-better 2)) (macroexpand '(infix-better (10 * 2))))

  "Things don't always work as you would like them to... "
  (= '(+ (koans.17-macros/infix-better 10) (koans.17-macros/infix-better (2 * 3))) (macroexpand '(infix-better ( 10 + (2 * 3)))))
